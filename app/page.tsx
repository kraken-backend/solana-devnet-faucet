    ...
    <main className="relative min-h-screen flex flex-col items-center justify-between p-0 bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-black">
      ...
      <div className="w-full px-4 lg:px-24 py-4 lg:py-24 flex flex-col items-center">
        ...
        <div className="relative w-full max-w-4xl mx-auto mb-8 px-4">
          <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl border border-indigo-400 dark:border-indigo-500 p-3 md:p-4 shadow-lg">
            <div className="flex flex-col sm:flex-row items-center justify-center text-center sm:text-left gap-2 sm:gap-3">
              <div className="flex items-center">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 text-white flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="text-white underline hover:no-underline font-bold text-sm sm:text-base md:text-lg break-all sm:break-normal"
              >
